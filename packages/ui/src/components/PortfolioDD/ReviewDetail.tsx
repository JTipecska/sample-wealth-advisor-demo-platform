      ...
      headerContent={
        session?.status === 'complete' ? (
          <button
            onClick={() =>
              navigate({
                to: '/portfolio-dd/$reviewId/report',
                params: { reviewId },
              })
            }
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="flex-1 py-1 text-xs bg-amber-500 text-white rounded hover:bg-amber-600"
                            >
                              Escalate
                            </button>
                          </div>
            ...
            >
              ...
              {events.map((ev, i) => (
                <div key={i} className="flex gap-2 items-start">
                  {ev.rag_status && (
                    <span
                      className={`mt-0.5 w-2 h-2 rounded-full flex-shrink-0 ${RAG_DOT[ev.rag_status] ?? RAG_DOT.grey}`}
                    />
                  )}
